...
pub fn usage(long: bool) {
    ...
    println!("                             the pointer follows by default.");
    println!("  output focus-warp <on|off|toggle>");
    println!("                             Control whether output focus warps the");
    println!("                             pointer (default: on).");
    ...
    println!("  output list                Describe connected outputs");
    println!("                             Output geometry and pointer adjacency are");
    println!("                             configured by an output manager such as kanshi.");
    println!();
